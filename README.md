...
This project was independently designed and developed by me, drawing inspiration from the **Data Visualization** course at Nova School of Business and Economicsthe completed during my degree. The analytical structure follows the same methodology: two complementary datasets merged into a country-year panel, three analytical questions, and interactive Tableau dashboards but the topic, datasets, research questions, code and conclusions are entirely my own original work.
